...
class CircularCounterView : View {
    ...
    private fun getShrinkTimer(
        ...
        private var radiusPercentDelta =
            calculateSizeChangeDuration(abs(factorFrom - factorTo), duration)
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.drawText(
            String.format("%1.1f", durationRemaining.toDouble() / 1000),
            centerX,
            centerY,
            textPaint
        )
